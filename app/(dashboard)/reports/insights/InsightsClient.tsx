...
import { Sparkles, TrendingDown, CreditCard, BarChart2, Target, Lightbulb } from 'lucide-react'
...
export function InsightsClient({ period, initialInsight }: Props) {
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <label htmlFor="insights-period" className="text-[13px] font-medium font-heading text-[#6b7a8d]">Period</label>
          <input
            id="insights-period"
            type="month"
            value={period}
